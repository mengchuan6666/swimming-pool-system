...
CREATE TABLE `sys_dept` (
  ...
  `pid` int(11) DEFAULT NULL COMMENT '父班级id',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='班级表';
...
INSERT INTO `sys_menu` VALUES ('131', 'dept', 'system', '[0],[system],', '班级管理', null, '/dept', '3', '2', '1', null, '1', null);
...
INSERT INTO `sys_menu` VALUES ('135', 'dept_add', 'dept', '[0],[system],[dept],', '添加班级', null, '/dept/add', '1', '3', '0', null, '1', null);
INSERT INTO `sys_menu` VALUES ('136', 'dept_update', 'dept', '[0],[system],[dept],', '修改班级', null, '/dept/update', '1', '3', '0', null, '1', null);
INSERT INTO `sys_menu` VALUES ('137', 'dept_delete', 'dept', '[0],[system],[dept],', '删除班级', null, '/dept/delete', '1', '3', '0', null, '1', null);
...
INSERT INTO `sys_menu` VALUES ('152', 'to_dept_update', 'dept', '[0],[system],[dept],', '修改班级跳转', '', '/dept/dept_update', '4', '3', '0', null, '1', null);
INSERT INTO `sys_menu` VALUES ('153', 'dept_list', 'dept', '[0],[system],[dept],', '班级列表', '', '/dept/list', '5', '3', '0', null, '1', null);
INSERT INTO `sys_menu` VALUES ('154', 'dept_detail', 'dept', '[0],[system],[dept],', '班级详情', '', '/dept/detail', '6', '3', '0', null, '1', null);
...
CREATE TABLE `sys_role` (
  ...
  `deptid` int(11) DEFAULT NULL COMMENT '班级名称',
  `tips` varchar(255) DEFAULT NULL COMMENT '提示',
