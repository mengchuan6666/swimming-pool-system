...
Dept.initColumn = function () {
    return [
        ...
        {title: '班级简称', field: 'simplename', align: 'center', valign: 'middle', sortable: true},
        {title: '班级全称', field: 'fullname', align: 'center', valign: 'middle', sortable: true},
...
Dept.delete = function () {
    if (this.check()) {
        ...
        Feng.confirm("是否刪除该班级?", operation);
    }
};
