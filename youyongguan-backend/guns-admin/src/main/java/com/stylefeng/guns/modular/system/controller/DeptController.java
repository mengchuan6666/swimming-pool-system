...
public class DeptController extends BaseController {
     ...
     * 新增班级
     */
    @BussinessLog(value = "添加班级", key = "simplename", dict = DeptDict.class)
     ...
     * 修改班级
     */
    @BussinessLog(value = "修改班级", key = "simplename", dict = DeptDict.class)
     ...
     * 删除班级
     */
    @BussinessLog(value = "删除班级", key = "deptId", dict = DeptDict.class)
